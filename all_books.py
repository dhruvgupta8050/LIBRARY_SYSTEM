...
lb1=Label(header,text="ALL BOOKS DETAIL",font=("harrington",45,"bold"),width=38,fg="lime",bg="black")
lb1.grid(row=0,column=0)


#Canvas to insert frame in it
canvas=Canvas(win,height=505,width=650)
canvas.pack(side=LEFT,fill=BOTH,expand=TRUE,padx=250)
...
lb=Label(details,text="Book Name",font=("Comic Sans MS",10,"bold")).grid(row=0,column=0,sticky=W,padx=20,pady=3)
lb=Label(details,text="ISBN",font=("Comic Sans MS",10,"bold")).grid(row=0,column=1,sticky=W,padx=20,pady=3)
lb=Label(details,text="Total Books",font=("Comic Sans MS",10,"bold")).grid(row=0,column=2,sticky=W,padx=20,pady=3)
lb=Label(details,text="Books Issued",font=("Comic Sans MS",10,"bold")).grid(row=0,column=3,sticky=W,padx=20,pady=3)
lb=Label(details,text="Available",font=("Comic Sans MS",10,"bold")).grid(row=0,column=4,sticky=W,padx=20,pady=3)
